    ...
    <div class="w3-text-white w3-center">
        <table>
            <tr id="header">
                ...
                <td>
                    <button id="home" class="w3-btn w3-round-large" style="height:50px;padding: 0" onclick="window.location.href='./?url=Dashboards'"> <img src="<?php echo URLROOT; ?>img/btn_home.png"></button>
                </td>
            </tr>
        </table>
    </div>
                        ...
                        <div class="col-8 t2">
                            <select id="switch_job_id" class="t2 form-control input-ms" onchange="seq_list_update()">
                                ...
                                foreach ($data['job_list'] as $key => $value) {
                                     echo "<option value='".$value['job_id']."' >".$value['job_id']." ".$value['job_name']."</option>";
