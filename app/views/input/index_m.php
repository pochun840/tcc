    ...
    <div class="main-content">
        <div class="center-content">
            <div class="topnav">
                ...
                <input type="text" id="job_id" name="job_id" size="8" maxlength="20"  disabled style="height:30px; font-size:3vmin;text-align: center; background-color: #DDDDDD; border:0;">&nbsp;&nbsp;
