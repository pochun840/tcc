        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content w3-animate-zoom" style="width: auto">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button id="" class="button-modal" onclick="document.getElementById('newjob').style.display='none'" class="closebtn">Close</button>
                </div>
            </div>
        </div>
    </div>
...
function savejob() {
    ...
    if (jobname_val && unscrew_rpm_val && unscre_power_val && direction_val) {
        ...
        var params = "jobidnew=" + jobidnew +
                     "&jobname_val=" + encodeURIComponent(jobname_val) +
                     "&unscrew_rpm_val=" + encodeURIComponent(unscrew_rpm_val) +
                     "&unscre_power_val=" + encodeURIComponent(unscre_power_val) +
                     "&direction_val=" + encodeURIComponent(direction_val);
        xhr.send(params);
    }
}
