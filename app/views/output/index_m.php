                    ...
                    <div class="modal-content w3-animate-zoom" style="width: auto">
                        ...
                        <div class="modal-body" id="new_output">
                            <form id="new_output_from" style="padding-left: 2%; padding-right: 1%">
                                ...
                                <div class="output-pins-container">
                                    <?php for ($i = 1; $i <= 9; $i++): ?>
                                        <div class="row output-pin">
                                            <div class="col t1"><?php echo $i; ?>:</div>

                                            <div class="col t2 form-check form-check-inline">
                                                <input class="zoom form-check-input" type="radio" name="pin_option" id="pin<?php echo $i; ?>_1" value="1" onclick="toggleOnputTime('pin<?php echo $i; ?>_1', this.checked, '1')">
                                                <label class="form-check-label" for="pin<?php echo $i; ?>_signal01"><img src="./img/signal01.png"></label>
                                            </div>

                                            <div class="col t2 form-check form-check-inline">
                                                <input class="zoom form-check-input" type="radio" name="pin_option" id="pin<?php echo $i; ?>_3" value="3" onclick="toggleOnputTime('pin<?php echo $i; ?>_3', this.checked, '2')">
                            ...
                            <form id="new_output_from" style="padding-left: 2%; padding-right: 1%">
								...
								<?php for ($i = 1; $i <= 9; $i++) {?>
									...
									<div class="row output-pin">
										...
										<div class="col t2 form-check form-check-inline">
											<input class="zoom form-check-input" type="radio" name="edit_pin_option" id="edit_pin<?php echo $i; ?>_3" value="3" onclick="toggleOnputTime_edit('edit_pin<?php echo $i; ?>_1', this.checked,'2')" >
											<label class="form-check-label" for="pin1_trigger"><img src="./img/trigger.png"></label>
										</div>

                                        <div class="col t2 form-check form-check-inline">
											<input class="zoom form-check-input" type="radio" name="edit_pin_option" id="edit_pin<?php echo $i; ?>_2" value="2" onclick="toggleOnputTime_edit('edit_pin<?php echo $i; ?>_1', this.checked,'3')" >
