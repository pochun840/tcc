                            ...
                            <form id="new_output_form" style="padding-left: 5%">
								...
								<?php for ($i = 1; $i <= 9; $i++) {?>
										<div class="row output-pin">
											...
											<div class="col-sm-2 t2 form-check form-check-inline">
												<input class="form-check-input" type="radio" name="edit_pin_option" id="edit_pin<?php echo $i; ?>_3" value="3" onclick="toggleOnputTime_edit('edit_pin<?php echo $i; ?>_3', this.checked,'2')">
