<?php
// 統一處理扭力單位顯示，避免 Lbf.in / lbf.in 大小寫或語系 key 不一致時括號空白。
$raw_unit_name = $data['unit_name'] ?? '';
$unit_label_candidates = array_unique([
    $raw_unit_name,
    strtolower((string)$raw_unit_name),
    str_ireplace('lbf.in', 'Lbf.in', (string)$raw_unit_name),
    str_ireplace('lbf.in', 'lbf.in', (string)$raw_unit_name),
]);
$unit_label = $raw_unit_name;
foreach ($unit_label_candidates as $unit_key) {
    if ($unit_key !== '' && isset($text[$unit_key]) && $text[$unit_key] !== '') {
        $unit_label = $text[$unit_key];
        break;
    }
}
$unit_label = htmlspecialchars((string)$unit_label, ENT_QUOTES, 'UTF-8');
?>
...
<div class="container-ms">
    ...
    <div class="main-content">
        <div class="center-content">
            <div class="topnav">
                ...
                style="height:30px; font-size:2.5vmin;text-align: center; background-color: #DDDDDD; border:0; margin: 3px;">

                <label style="font-size:2.5vmin;color: #000; padding-left: 2%" for="seq_id"><?php echo $text['seq_id'];?> :</label>&nbsp;
                <input type="text" id="seq_id" name="seq_id" size="5" maxlength="20" value="<?php echo $data['seq_id'];?>" disabled
                style="height:30px; font-size:2.5vmin;text-align: center; background-color: #DDDDDD; border:0; margin: 3px;">
    ...
    <div class="footer">
        ...
        <input id="hq_torque_limit" value="<?php echo $data['hq_torque_limit'] ?? 55; ?>">
        </div>
                ...
                <div class="modal-body">
                    <form id="new_step_form" style="padding-left: 0%">
                        ...
                        <div id='target_tor_item' style="display:block;">
                            <div class="row">
                                <div  class="col-6 t1"><?php echo $text['Target_Torque'];?> (<?php echo $unit_label; ?>):</div>
                                <div class="col-4 t2">
                                    <input type="text" step="0.00001" min="0"  class="form-control input-ms" id="target_tor" maxlength="" >
                        ...
                        <div id="tor_hi_item">                   
                            <div class="row">
                                <div for="hi-torque" class="col-6 t1"><?php echo $text['High_Torque'];?> (<?php echo $unit_label; ?>):</div>
                                <div class="col-4 t2">
                         ...
                         <div id="tor_lo_item">
                            <div class="row">
                                <div for="lo-torque" class="col-6 t1"><?php echo $text['Low_Torque'];?> (<?php echo $unit_label; ?>):</div>
                                <div class="col-4 t2">
                        ...
                        <div id='th_tor_item'>
                            <div class="row" >
                                <div id="downshift_threshold_title" for="th_tor" class="col-6 t1"><?php echo $text['Threshold_Torque'];?>(<?php echo $unit_label; ?>):</div>
                        ...
                        <div id='ds_tor_item'>
                            <div class="row" >
                                <div id="downshift_torque_title" for="ds_tor" class="col-6 t1"><?php echo $text['Downshift_Torque'];?>(<?php echo $unit_label; ?>):</div>
                                <div class="col-4 t2" id="downshift_torque_item">
                                    <input type="text" class="form-control input-ms" id="ds_tor" step="0.00001" min="0"  maxlength="" >
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <form id="new_step_form" style="padding-left: 0%">
                        ...
                        <div id="edit_th_mode_item">
                            <div class="row">
                                ...
                                <div class="col t2" >
                                    <div class="col-4 form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="edit_th_mode" id="edit_downshift_OFF" value="0">
                                    <label class="form-check-label" for="downshift_OFF"><?php echo $text['switch_off'];?></label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="edit_th_mode" id="edit_downshift_ON" value="1" >
                        ...
                        <div id="edit_th_tor_item">
                            <div class="row">
                                <div class="col-6 t1"><?php echo $text['Threshold_Torque'];?>(<?php echo $unit_label; ?>):</div>
                                <div class="col-4 t2">
                        ...
                        <div id="edit_ds_tor_item">
                            <div class="row">
                                <div class="col-6 t1"><?php echo $text['Downshift_Torque'];?>(<?php echo $unit_label; ?>):</div>
            ...
            <div class="modal-content w3-animate-zoom" style="width: 80%">
                ...
                <div class="modal-body">
                    <form id="new_step_form">
        	            <div for="from_step_id" class="col" style="font-weight: bold"><?php echo $text['copy_from'];?></div>
       		            <div class="row"  style="padding-left: 10%">
      				        <div for="from_step_id" class="t1 col-6"><?php echo $text['step_id'];?> :</div>
      				        <div class="col-4 t2 ">
       				            <input type="number" class="form-control" id="from_step_id" disabled>
       				        </div>
       				    </div>

        			    <div for="from_step_id" class="col" style="font-weight: bold"><?php echo $text['copy_to'];?></div>
       				    <div class="row"  style="padding-left: 10%">
       				        <div for="to_step_id" class="t1 col-6"><?php echo $text['step_id'];?> :</div>
       				        <div class="t2 col-4">
...
<script>
    ...
    function add_step() {
        ...
        var th_mode = document.querySelector('input[name="th_mode"]:checked')?.value || 0;
    ...
    function edit_step_save() {
        ...
        var record_ang = 0;
        var tor_unit   = String(step_torque_unit || val('step_torque_unit') || '<?php echo $data['step_torque_unit'] ?>');
