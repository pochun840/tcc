...
function renderTableRows($records, $unit_arr, $status_arr, $text) {
    foreach ($records as $row) {
        ...
        echo "<tr>
                <td>{$row['system_sn']}</td>
                <td>{$row['data_time']}</td>
                <td title='{$jobNameEscaped}'>{$jobNameShort}</td>
                <td title='{$seqNameEscaped}'>{$seqNameShort}</td>
    ...
    records.forEach(row => {
        ...
        const html = `
            <tr>
                <td>${row.system_sn}</td>
                <td>${row.data_time}</td>
                <td data-toggle="tooltip" title="${jobNameFull}">${jobNameShort}</td>
                <td data-toggle="tooltip" title="${seqNameFull}">${seqNameShort}</td>
                <td>${row.fasten_torque}</td>
