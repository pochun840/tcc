...
$text['step_id'] = '鎖附步驟編號';
$text['step_tor_unit'] = '鎖附扭力單位';
$text['step_tar_type'] = '鎖附目標類型';
$text['step_tar_tor'] = '目標扭力';
$text['step_tar_ang'] = '目標角度';
$text['target_time'] = '目標時間';
$text['fasten_time'] = '總鎖附時間';
$text['fasten_torque'] = '鎖附扭力';
$text['fasten_angle'] = '鎖附角度';
...
$error_message['seq_name'] = '工序名稱輸入有誤';
...
$text['idas_pack_name_invalid'] = '更新檔檔名格式錯誤';
$text['info_json_idas_invalid']  = 'info.json 格式錯誤（IDAS 不符）';
