...
$text['Turning CW']  = '顺时针转动';
$text['Turning CCW'] = '逆时针转动';
...
$text['step_tar_type'] = '锁附目标类型';
$text['step_tar_tor'] = '目标扭力';
$text['step_tar_ang'] = '目标角度';
$text['target_time'] = '目标时间';
$text['fasten_time'] = '总锁附时间';
$text['fasten_torque'] = '锁附扭力';
$text['fasten_angle'] = '锁附角度';
...
$text['step_rpm'] = '锁附转速';
$text['step_hi_tor'] = '锁附扭力上限';
$text['step_lo_tor'] = '锁附扭力下限';
$text['step_hi_ang'] = '锁附角度上限';
$text['step_lo_ang'] = '锁附角度下限';
$text['step_delay_time'] = '延迟时间';
...
//main 主畫面image url
$text['img_job'] = URLROOT . 'img/home_job_cn.png';
$text['img_job_hover'] = URLROOT . 'img/home_job_m_cn.png';

$text['img_io_input'] = URLROOT . 'img/home_input_cn.png';
$text['img_io_input_hover'] = URLROOT . 'img/home_m_input_cn.png';

$text['img_io_output'] = URLROOT . 'img/home_output_cn.png';
$text['img_io_output_hover'] = URLROOT . 'img/home_m_output_cn.png';

$text['img_operation'] = URLROOT . 'img/home_operation_cn.png';
$text['img_operation_hover'] = URLROOT . 'img/home_m_operation_cn.png';

$text['img_data'] = URLROOT . 'img/home_data_cn.png';
$text['img_data_hover'] = URLROOT . 'img/home_m_data_cn.png';

$text['img_tool'] = URLROOT . 'img/home_tool_cn.png';
$text['img_tool_hover'] = URLROOT . 'img/home_m_tool_cn.png';

$text['img_setting'] = URLROOT . 'img/home_setting_cn.png';
$text['img_setting_hover'] = URLROOT . 'img/home_m_setting_cn.png';

$text['img_load'] = URLROOT . 'img/home_load_cn.png';
$text['img_load_hover'] = URLROOT . 'img/home_load_m_cn.png';

$text['img_save'] = URLROOT . 'img/home_save_cn.png';
$text['img_save_hover'] = URLROOT . 'img/home_save_m_cn.png';

$text['img_agent'] = URLROOT . 'img/home_agent_cn.png';
$text['img_agent_hover'] = URLROOT . 'img/home_m_agent_cn.png';

$text['img_remote'] = URLROOT . 'img/home_command_cn.png';
$text['img_remote_hover'] = URLROOT . 'img/home_m_command_cn.png';
...
$error_message['threshold_torque_error'] = '门槛点扭力不可大于目标扭力';
$error_message['downshift_torque_error'] = '降速点扭力不可大于目标扭力';
