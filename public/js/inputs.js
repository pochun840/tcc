   ...
   if (jobid) {
       $.ajax({
           ...
           success: function(response) {
               ...
               const labels = {
                   '101': { 'zh-cn': '禁用', 'zh-tw': '禁用' },
                   '102': { 'zh-cn': '启用', 'zh-tw': 'Enable' },
                   '103': { 'zh-cn': '颗数清除', 'zh-tw': '清除顆數' },
                   '104': { 'zh-cn': '确认', 'zh-tw': '確認' },
                   '105': { 'zh-cn': '启动', 'zh-tw': '啟動' },
                   '106': { 'zh-cn': '拆螺丝', 'zh-tw': '拆螺絲' },
                   '107': { 'zh-cn': '工序清除', 'zh-tw': '工序清除' },
                   '108': { 'zh-cn': '重启', 'zh-tw': '重啟' },
                   '109': { 'zh-cn': '一次感应', 'zh-tw': '一次感應' },
                   '110': { 'zh-cn': '自定义1', 'zh-tw': '自定義1' },
                   '111': { 'zh-cn': '自定义2', 'zh-tw': '自定義2' },
                   '112': { 'zh-cn': '自定义3', 'zh-tw': '自定義3' },
                   '113': { 'zh-cn': '自定义4', 'zh-tw': '自定義4' },
                   '114': { 'zh-cn': '自定义5', 'zh-tw': '自定義5' },
               };
